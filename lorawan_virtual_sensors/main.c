...
static uint8_t deveui[LORAMAC_DEVEUI_LEN]= { 0x00, 0x5B, 0x99, 0x18, 0xF4, 0x58, 0xCC, 0x79 };
static uint8_t appeui[LORAMAC_APPEUI_LEN]= { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xD6, 0x3A };
static uint8_t appkey[LORAMAC_APPKEY_LEN]= { 0xC1, 0x38, 0x1B, 0xAC, 0x7C, 0xA6, 0xCA, 0xEF, 0xB1, 0xCF, 0x9A, 0x28, 0x72, 0x09, 0x02, 0xBC };
